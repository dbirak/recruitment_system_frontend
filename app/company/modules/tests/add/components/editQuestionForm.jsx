...
const EditQuestionForm = (props) => {
  ...
  const [answerInputs, setAnswerInputs] = useState([
    ...props.editedQuestion.odpowiedzi,
  ]);
      ...
      <Modal>
        ...
        <form onSubmit={handleSubmit(onSubmitHandler)}>
          <input
            ...
            defaultValue={props.editedQuestion.pytanie}
          ...
          <div className="w-full mx-auto mt-3 flex justify-around">
            <input
              ...
              type="submit"
              value="Edytuj pytanie"
            />
            <button
              className="block btn btn-error w-[150px]"
              onClick={props.closeEditQuestionModal}
            >
              Anuluj
            </button>
          </div>
