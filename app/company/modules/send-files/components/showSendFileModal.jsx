...
const ShowSendFileModal = (props) => {
  ...
  const getQuestion = useQuery("getQuestion", () => {
    axiosWithBearer
      .get("/company/file-task/" + props.fileTaskShowInfo.id)
      .then((res) => {
      ...
      <Modal3>
        ...
        {isLoading ? (
          ...
          <div>
            ...
            <button
              onClick={closeShowSendFileModal}
...
export default ShowSendFileModal;
